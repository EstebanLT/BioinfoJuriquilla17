...
```{r Q4}
#Dividing data in study subsets
CCLEData = subset(exerciseData, study == "CCLE")
CCLEData = subset(exerciseData, study == "GDSC")
...
head(Caca)
aggregate(Caca$viability,by = list(Caca$drug),FUN = nrow)
